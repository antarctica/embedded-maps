...
export const buttonRecipe = tv({
  ...
  variants: {
    variant: {
      mapButton:
        'rounded-full border-transparent bg-blue-9 text-white shadow-sm hover:bg-blue-10 active:brightness-92 active:saturate-110 disabled:bg-blue-9/70 theme-bsk1:border theme-bsk1:border-gray-8 theme-bsk1:bg-gray-2 theme-bsk1:text-gray-12 theme-bsk1:hover:bg-gray-3 theme-bsk1:disabled:bg-gray-2/70 theme-bsk1:disabled:text-gray-12/70',
    },
    size: {
